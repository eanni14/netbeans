 ...
 * @author ACER
 */
public class Karyawan_Login extends javax.swing.JFrame {
        ...
        if (txtusername.getText().trim().equals("")){
           ...
           txtpassword.requestFocus();
            ...
            try {
                ...
                ResultSet data = stat.executeQuery("SELECT * FROM `karyawan` WHERE username ='" + txtusername.getText() + "'");
                ResultSet aa = koneksi.createStatement().executeQuery("SELECT * FROM `karyawan` WHERE password ='" + txtpassword.getText() + "'");
                if (!data.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Karyawan_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
